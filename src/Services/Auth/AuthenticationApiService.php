...
use Modules\DesaModuleRelease\Http\Requests\Api\Auth\LoginRequest;
use Modules\DesaModuleRelease\Http\Resources\Shared\AuthenticatedUserResource;
...
class AuthenticationApiService
{
    ...
    public function login(LoginRequest $request)
    {
        ...
        try {
            if (!$token = auth('desa_module_release_api')->attempt($credentials)) {
                return [
                    'status' => 'error',
                    'code' => 401,
        ...
        $user = auth('desa_module_release_api')->user();
    ...
    {
        $status = Password::broker(desa_module_release_meta('snake') . '_users')->reset(
            $credentials,
