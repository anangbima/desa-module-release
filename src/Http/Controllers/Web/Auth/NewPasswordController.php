...
use Modules\DesaModuleRelease\Http\Requests\Web\Auth\NewPasswordRequest;
...
class NewPasswordController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view(desa_module_release_meta('kebab').'::web.auth.reset-password', $data);
    }
    ...
    public function store(NewPasswordRequest $request)
    {
        ...
        return $status == Password::PASSWORD_RESET
                    ? view(desa_module_release_meta('kebab').'::web.auth.reset-password-success', ['status' => __($status)])
