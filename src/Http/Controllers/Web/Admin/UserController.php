...
use Modules\DesaModuleRelease\Exporters\UserExporter;
use Modules\DesaModuleRelease\Http\Controllers\Controller;
use Modules\DesaModuleRelease\Http\Requests\Web\Admin\StoreUserRequest;
use Modules\DesaModuleRelease\Http\Requests\Web\Admin\UpdateUserRequest;
use Modules\DesaModuleRelease\Http\Requests\Web\Shared\ImportRequest;
use Modules\DesaModuleRelease\Importers\UserImporter;
...
use Modules\DesaModuleRelease\Services\Shared\ImportService;
...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(desa_module_release_meta('kebab').'::web.admin.user.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view(desa_module_release_meta('kebab').'::web.admin.user.create', $data);
    }
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return redirect()->route(desa_module_release_meta('kebab').'.admin.users.index')
    ...
    public function show(User $user)
    {
        ...
        return view(desa_module_release_meta('kebab').'::web.admin.user.show', $data);
    }
    ...
    public function edit(User $user)
    {
        ...
        return view(desa_module_release_meta('kebab').'::web.admin.user.edit', $data);
    }
    ...
    */
    public function export(string $type)
    {
        ...
        $fileName = desa_module_release_fileName('users_export', $type);
        $pdfView = desa_module_release_meta('kebab').'::pdf.users';
