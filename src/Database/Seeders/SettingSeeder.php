...
class SettingSeeder extends Seeder
{
    ...
    {
        $generalSettings = [
            ['key' => 'site_name', 'value' => 'Desa Module Release', 'type' => 'string'],
        ...
        $socialMediaSettings = [
            ['key' => 'facebook_url', 'value' => 'https://facebook.com/desamodulerelease', 'type' => 'string'],
            ['key' => 'twitter_handle', 'value' => '@desamodulerelease', 'type' => 'string'],
            ['key' => 'instagram_url', 'value' => 'https://instagram.com/desamodulerelease', 'type' => 'string'],
        ];
