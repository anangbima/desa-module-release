...
{
    protected $signature;
    protected $description = 'Generate a new repository and optionally its interface in the Desa Module Release module';

    public function __construct()
    {
        $this->signature = 'module:desamodulerelease:make-repository
    ...
    public function handle(): int
    {
        ...
        $repoNamespace = 'Modules\\DesaModuleRelease\\Repositories';
        $interfaceNamespace = 'Modules\\DesaModuleRelease\\Repositories\\Interfaces';

        $repoPath = base_path('Modules/desa-module-release/src/Repositories/'.$className.'.php');
        $interfacePath = base_path('Modules/desa-module-release/src/Repositories/Interfaces/'.$interfaceName.'.php');
    ...
    {
        $traitPath = base_path('Modules/desa-module-release/src/Providers/Concerns/BindRepositories.php');
