...
class MigrateCommand extends Command
{
     ...
     */
    protected $signature;
    protected $description = 'Run migrations for Desa Module Release';
    ...
    public function __construct()
    {
        ...
        $this->signature = 'module:desamodulerelease:migrate
    ...
    public function handle()
    {
        ...
        $connection = config('desa_module_release.database.database_connection', 'desa_module_release');
        $database = config('desa_module_release.database.connection.database', 'desa_module_release');
        ...
        $realMigrationPath = base_path('modules/desa-module-release/src/Database/Migrations');
