...
{
    protected $signature;
    protected $description = 'Generate a new model and migration for Desa Module Release';

    public function __construct()
    {
        $this->signature = 'module:desamodulerelease:make-model
    ...
    public function handle(): int
    {
        ...
        $modelDir = base_path('Modules/desa-module-release/src/Models');
        $migrationDir = base_path('Modules/desa-module-release/src/Database/Migrations');
        $moduleNamespace = 'Modules\\DesaModuleRelease\\';
        ...
        $modelStub = str_replace(
            ...
            ['Modules\\DesaModuleRelease\\Models', $modelName, 'desa_module_release', $tableName, $tableName],
            $modelStub
        );
        ...
        $migrationStub = str_replace(
            ...
            [$migrationClass, desa_module_release_meta('snake'), 'table_name', $tableName, $moduleNamespace],
            $migrationStub
        );        
        ...
        // ==== CONFIG OVERRIDE ====
        $configFolder = base_path('Modules/desa-module-release/config/'.$tableName);
