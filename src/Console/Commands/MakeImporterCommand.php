...
{
    protected $signature;
    protected $description = 'Generate a new importer for model Desa Module Release';

    public function __construct()
    {
        $this->signature = 'module:desamodulerelease:make-importer
    ...
    public function handle()
    {
        ...
        $namespace = 'Modules\\DesaModuleRelease\\Importers';
        $targetPath = base_path('Modules/desa-module-release/src/Importers/'.$className.'.php');
