...
class MakeRequestCommand extends Command
{
     ...
     */
    protected $signature;
    protected $description = 'Generate a new Form Request file in the Desa Module Release module';

    public function __construct()
    {
        $this->signature = 'module:desamodulerelease:make-request
    ...
    public function handle(): int
    {
        ...
        $namespace = "Modules\\DesaModuleRelease\\Http\\Requests" . ($namespaceSuffix ? "\\$namespaceSuffix" : '');
        $basePath = base_path('Modules/desa-module-release/src/Http/Requests' . ($subPath ? '/' . $subPath : ''));
