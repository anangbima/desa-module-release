...
class MakeRepositoryInterfaceCommand extends Command
{
     ...
     */
    protected $signature;
    protected $description = 'Generate a new repository interface file in the Desa Module Release module';

    public function __construct()
    {
        $this->signature = 'module:desamodulerelease:make-repository-interface
    ...
    public function handle(): int
    {
        ...
        $namespace = 'Modules\\DesaModuleRelease\\Repositories\\Interfaces' . ($namespaceSuffix ? "\\$namespaceSuffix" : '');
        $basePath = base_path('Modules/desa-module-release/src/Repositories/Interfaces' . ($subPath ? "/$subPath" : ''));
