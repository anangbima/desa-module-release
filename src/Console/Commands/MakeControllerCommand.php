...
class MakeControllerCommand extends Command
{
     ...
     */
    protected $description = 'Generate a new controller file in the Desa Module Release module';

    public function __construct()
    {
        $this->signature = 'module:desamodulerelease:make-controller
    ...
    public function handle()
    {
        ...
        $namespace = 'Modules\\DesaModuleRelease\\Http\\Controllers' . ($namespaceSuffix ? "\\$namespaceSuffix" : '');
        $basePath = base_path('Modules/desa-module-release/src/Http/Controllers' . ($subPath ? '/' . $subPath : ''));
        $filePath = "$basePath/{$className}.php";
        $controllerNamespace = 'Modules\\DesaModuleRelease\\Http\\Controllers';
