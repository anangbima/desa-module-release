...
{
    protected $signature;
    protected $description = 'Generate a new seeder for Desa Module Release';

    public function __construct()
    {
        $this->signature = 'module:desamodulerelease:make-seeder
    ...
    public function handle()
    {
        ...
        $modelNamespace = 'Modules\\DesaModuleRelease\\Models\\' . $model;
        ...
        $namespace = 'Modules\\DesaModuleRelease\\Database\\Seeders' . ($subNamespace ? "\\{$subNamespace}" : '');
        $targetPath = base_path("Modules/desa-module-release/src/Database/Seeders"
            . ($subPath ? "/{$subPath}" : '')
            . "/{$className}.php");
