...
class MakeTraitCommand extends Command
{
     ...
     */
    protected $signature;
    protected $description = 'Generate a new traits class in the Desa Module Release module';

    public function __construct()
    {
        $this->signature = 'module:desamodulerelease:make-trait
    ...
    public function handle(): int
    {
        ...
        $namespace = "Modules\\DesaModuleRelease\\Traits" . ($namespaceSuffix ? "\\$namespaceSuffix" : '');
        $basePath = base_path('Modules/desa-module-release/src/Traits' . ($subPath ? '/' . $subPath : ''));
