...
{
    protected $signature;
    protected $description = 'Generate a new factory for model and migration for Desa Module Release';

    public function __construct()
    {
        $this->signature = 'module:desamodulerelease:make-factory
    ...
    public function handle()
    {
        ...
        $targetPath = base_path('Modules/desa-module-release/src/Database/Factories/'.$className.'.php');
