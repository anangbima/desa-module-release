...
class UpdateAutoloadCommand extends Command
{
     ...
     */
    protected $signature;
    protected $description = 'Backup and update composer.json to register PSR-4 for Desa Module Release';

    public function __construct()
    {
        $this->signature = 'module:desamodulerelease:update-autoload';
        parent::__construct();
    }
    ...
    public function handle(): void
    {
        ...
        $namespace = 'Modules\\DesaModuleRelease\\';
        $path = 'modules/desa-module-release/src/';
        ...
        $this->newLine();
        $this->info('✅ Autoload update completed for Desa Module Release .');
    }
}